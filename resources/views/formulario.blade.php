...
<head>
    ...
    <style>
        ...
        /* Eliminar el footer para conseguir una linea rosa separadora */
        footer {
...
<body>
    ...
    <main>
        ...
        @auth <!--Si está autenticado-->
            @if(auth()->check() && auth()->user()->es_trabaj == 1) <!--Escondido si no es admin o trabajador-->
                <section class="seccion-animal">
                    <h2>Hola {{ auth()->user()->usuario }}</h2> <!--Cambiar cuando se sepa la implementación de los roles trabajador/admin-->
                    <div class="msg">
    ...
    <div class="cookie-banner">
        ...
        <div class="cookie-msg">
            ...
            <p>Mejoran la experiencia de navegación al recordar accesos, preferencias y carritos de compra, aunque algunas rastrean hábitos para marketing.</p>
            <p>Se pueden gestionar desde la configuración del navegador. Santuario de la Frontera &copy no distribuye información personal a terceros ni asociados.</p>
